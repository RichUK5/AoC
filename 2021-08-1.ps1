...
[string[]]$Patterns, [string[]]$Output = $Array -split " \| "

$Groups = ($Displays.Output | ForEach-Object { $_ | Measure-Object -Character }).Characters | Group-Object
return ($Groups | Where-Object { $_.Name -eq 2 -or $_.Name -eq 3 -or $_.Name -eq 4 -or $_.Name -eq 7} | Measure-Object -Property "Count" -Sum).Sum
