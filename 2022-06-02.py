...
class Test(unittest.TestCase):
    ...
    def test_Part2_1(self):
        self.assertEqual(19,Part2(TestData1))
    def test_Part2_2(self):
        self.assertEqual(23,Part2(TestData2))
    def test_Part2_3(self):
        self.assertEqual(23,Part2(TestData3))
    def test_Part2_4(self):
        self.assertEqual(29,Part2(TestData4))
    def test_Part2_5(self):
        self.assertEqual(26,Part2(TestData5))
